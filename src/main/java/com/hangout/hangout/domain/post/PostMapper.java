...
public class PostMapper {
    ...
    public static PostResponse of(Post post, List<String> tags, List<String> imageUrls, int likeStatus, Long viewCount) { // 유저 정보 추가 예정 // 목록 상세 조회 시 사용
        return PostResponse.builder()
                ...
                .gender(post.getUser().getGender().getGender())
                .age(post.getUser().getAge())
                .description(post.getUser().getDescription())
                ...
                .latitude(post.getPostInfo().getMap().getLatitude())
                .longitude(post.getPostInfo().getMap().getLongitude())
