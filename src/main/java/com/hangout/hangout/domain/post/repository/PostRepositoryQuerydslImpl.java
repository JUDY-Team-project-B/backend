...
public class PostRepositoryQuerydslImpl implements PostRepositoryQuerydsl{
    ...
    @Override
    public Page<Post> findAllContainTitleAndContextByCreatedAtDesc(Pageable pageable, String searchKeyword) {

        BooleanExpression titleOrContextContainsKeyword = post.title.containsIgnoreCase(searchKeyword)
    ...
    @Override
    public Page<Post> findAllContainContextByCreatedAtDesc(Pageable pageable, String searchKeyword) {
    ...
    @Override
    public Page<Post> findAllContainNicknameByCreatedAtDesc(Pageable pageable, String searchKeyword) {
        BooleanExpression nicknameContainsKeyword = user.nickname.likeIgnoreCase("%" + searchKeyword + "%");
